...
namespace HMS_WebAPI.Migrations
{
    ...
    [Migration("20240404201246_Reservation")]
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.NewsItemModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2024, 4, 4, 0, 0, 0, 0, DateTimeKind.Local),
                            PictureId = 1,
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.ReservationModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CheckInTime = new DateTime(2024, 4, 4, 22, 12, 45, 553, DateTimeKind.Local).AddTicks(1557),
                            FromDate = new DateTime(2024, 4, 4, 0, 0, 0, 0, DateTimeKind.Local),
                            PIN = "123456",
                            Price = 12999m,
                            RoomId = 1,
                            ToDate = new DateTime(2024, 4, 6, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 2,
                            FromDate = new DateTime(2024, 4, 14, 0, 0, 0, 0, DateTimeKind.Local),
                            PIN = "112233",
                            Price = 12999m,
                            RoomId = 1,
                            ToDate = new DateTime(2024, 4, 18, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.RestaurantSalesModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateOfPayment = new DateTime(2024, 4, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            DateOfSales = new DateTime(2024, 4, 2, 0, 0, 0, 0, DateTimeKind.Local),
                            GuestId = 1,
                            MenuItemId = 1,
                            Price = 1699m
                        },
                        ...
                        {
                            Id = 2,
                            DateOfSales = new DateTime(2024, 4, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            GuestId = 1,
                            MenuItemId = 2,
                            Price = 2899m
                        });

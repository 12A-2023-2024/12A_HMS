...
namespace HMS_WebAPI.Migrations
{
    ...
    [Migration("20240503070301_SocialMediaContacts")]
    partial class SocialMediaContacts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.CoctailCategoryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.CoctailImageModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.CoctailModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("CoctailCategoryId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CoctailCategoryId = 2,
                            Description = "A klasszikus mojito: rum, mentalevél, lime, citrom",
                            Name = "Mojito",
                            Price = 1899m
                        },
                        new
                        {
                            ...
                            Active = true,
                            CoctailCategoryId = 2,
                            Description = "Vodka, paradicsomlé, citrlomé, só, bors, worcestershire szósz",
                            Name = "Boody Mary",
                            Price = 1499m
                        });
                });
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.ImageModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 10,
                            OriginalFileName = "husleves.jpg",
                            Path = "./files\\CE\\A2\\CEA2806130AA51D7746A8C0CF3D5536F7812F4FF.jpg"
                        },
                        new
                        {
                            Id = 11,
                            OriginalFileName = "mojito.jpg",
                            Path = "./files\\F6\\52\\F65207D984E489C6EE5C1DB3821BA31BECB826BA.jpg"
                        },
                        new
                        {
                            Id = 12,
                            OriginalFileName = "bloody-mary.jpg",
                            Path = "./files\\4A\\76\\4A769E1258DFC033D2222C846021A8186DEB140D.jpg"
                        });
                });
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.MenuCategoryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.MenuImageModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.MenuItemModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.ReservationModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CheckInTime = new DateTime(2024, 5, 3, 9, 3, 0, 970, DateTimeKind.Local).AddTicks(1013),
                            FromDate = new DateTime(2024, 5, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            PIN = "123456",
                            Price = 12999m,
                            RoomId = 1,
                            ToDate = new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 2,
                            FromDate = new DateTime(2024, 5, 13, 0, 0, 0, 0, DateTimeKind.Local),
                            PIN = "112233",
                            Price = 12999m,
                            RoomId = 1,
                            ToDate = new DateTime(2024, 5, 17, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });

            modelBuilder.Entity("HMS_WebAPI.Models.RestaurantSalesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("restaurantsales");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            DateOfPayment = new DateTime(2024, 5, 2, 0, 0, 0, 0, DateTimeKind.Local),
                            DateOfSales = new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            GuestId = 1,
                            MenuItemId = 1,
                            Price = 1699m
                        },
                        ...
                        {
                            Id = 2,
                            DateOfSales = new DateTime(2024, 5, 2, 0, 0, 0, 0, DateTimeKind.Local),
                            GuestId = 1,
                            MenuItemId = 2,
                            Price = 2899m
                        });
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.RoomModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.CoctailModel", b =>
                {
                    b.HasOne("HMS_WebAPI.Models.CoctailCategoryModel", "CoctailCategory")
                        .WithMany()
                        .HasForeignKey("CoctailCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.ContactSocialmediaItemModel", b =>
                {
                    b.HasOne("HMS_WebAPI.Models.ContactModel", null)
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.GuestReservationModel", b =>
                {
                    ...
                    b.HasOne("HMS_WebAPI.Models.ReservationModel", "Reservation")
                        .WithMany("Guests")
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.MenuImageModel", b =>
                {
                    ...
                    b.HasOne("HMS_WebAPI.Models.MenuItemModel", "MenuItem")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.MenuItemModel", b =>
                {
                    b.HasOne("HMS_WebAPI.Models.MenuCategoryModel", "MenuCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("HMS_WebAPI.Models.ReservationModel", b =>
                {
                    b.HasOne("HMS_WebAPI.Models.RoomModel", "Room")
                        .WithMany()
